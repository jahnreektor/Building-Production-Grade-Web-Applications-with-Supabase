...
alter table
  "public"."service_users" enable row level security;
...
alter table
  "public"."tenant_permissions" enable row level security;
...
add
  constraint "service_users_pkey" PRIMARY KEY using index "service_users_pkey";

alter table
  "public"."tenant_permissions"
add
  constraint "tenant_permissions_pkey" PRIMARY KEY using index "tenant_permissions_pkey";

alter table
  "public"."tenants"
add
  constraint "tenants_pkey" PRIMARY KEY using index "tenants_pkey";

alter table
  "public"."service_users"
add
  constraint "service_users_supabase_user_fkey" FOREIGN KEY (supabase_user) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table
  "public"."service_users" validate constraint "service_users_supabase_user_fkey";

alter table
  "public"."service_users"
add
  constraint "service_users_supabase_user_key" UNIQUE using index "service_users_supabase_user_key";

alter table
  "public"."tenant_permissions"
add
  constraint "tenant_permissions_service_user_fkey" FOREIGN KEY (service_user) REFERENCES service_users(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table
  "public"."tenant_permissions" validate constraint "tenant_permissions_service_user_fkey";

alter table
  "public"."tenant_permissions"
add
  constraint "tenant_permissions_tenant_fkey" FOREIGN KEY (tenant) REFERENCES tenants(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table
  "public"."tenant_permissions" validate constraint "tenant_permissions_tenant_fkey";

alter table
  "public"."tenants"
add
  constraint "tenants_domain_key" UNIQUE using index "tenants_domain_key";

grant delete on table "public"."service_users" to "anon";

grant
insert
  on table "public"."service_users" to "anon";
...
grant
insert
  on table "public"."service_users" to "authenticated";
...
grant
insert
  on table "public"."service_users" to "service_role";
...
grant
insert
  on table "public"."tenant_permissions" to "anon";
...
grant
insert
  on table "public"."tenant_permissions" to "authenticated";
...
grant
insert
  on table "public"."tenant_permissions" to "service_role";
...
create policy "access own user data" on "public"."service_users" as permissive for
select
  to authenticated using (supabase_user = auth.uid());

create policy "allow reading own permissions" on "public"."tenant_permissions" as permissive for
select
  to authenticated using (
    exists (
      ...
      from
        service_users su
      where
        su.id = tenant_permissions.service_user
